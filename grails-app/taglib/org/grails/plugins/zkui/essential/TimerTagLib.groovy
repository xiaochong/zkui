...
class TimerTagLib extends AbstractTagLib {
    ...
    /**
     * Timer is a special component that is invisible. It fires one or more org.zkoss.zk.ui.event.Event after a specified delay. Notice that the timer won't fire any event until it is attached to a page.<br />
     *
     * @attr running Start or stops the timer.
     * @attr delay Sets the delay, the number of milliseconds between successive action events.
     * @attr repeats Sets whether the timer shall send Event repeatly.
