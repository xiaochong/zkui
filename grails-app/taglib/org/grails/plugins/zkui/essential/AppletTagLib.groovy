...
class AppletTagLib extends AbstractTagLib {
    ...
    /**
     * A generic applet component.If the properties are not enough, you can use <a href="/wiki/ZUML_Reference/ZUML/Namespaces/Client_Attribute" title="ZUML Reference/ZUML/Namespaces/Client Attribute"> the Client-Attribute namespace</a> to specify them.
     *
     * @attr code Sets the applet class to run.
     * @attr align Sets the alignment of an applet according to surrounding elements. Refer to HTML <applet> Tagfor more information.
     * @attr codebase Sets a relative base URL for applets specified in setCode(java.lang.String) (URL). Notice that, if URI is specified, it will be encoded (Execution.encodeURL(java.lang.String)).
     * @attr mayscript Sets whether the applet is allowed to access the scripting object.
     * @attr archive Sets the location of an archive file (URL). Notice that, if URI is specified, it will be encoded (Execution.encodeURL(java.lang.String)).
     * @attr hspace Sets the horizontal spacing in pixels around an applet.
     * @attr vspace Sets the vertical spacing in pixels around an applet.
