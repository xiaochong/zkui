...
class ATagLib extends AbstractTagLib {
    ...
    /**
     * The same as HTML A tag.<br />
     *
     * @attr dir Sets the direction to layout with image.
     * @attr disabled Sets whether it is disabled.
     * @attr tabindex Sets the tab order of this component.
     * @attr href Sets the href.
     * @attr target Sets the target frame or window.
     * @attr src Deprecated.  As of release 3.5.0, it is redudant since it is the same as setImage(java.lang.String)
     * @attr hoverImage Sets the image URI. The hover image is used when the mouse is moving over this component. Calling this method implies setHoverImageContent(null). In other words, the last invocation of setHoverImage(java.lang.String) overrides the previous setHoverImageContent(org.zkoss.image.Image), if any.
     * @attr image Sets the image URI. Calling this method implies setImageContent(null). In other words, the last invocation of setImage(java.lang.String) overrides the previous setImageContent(org.zkoss.image.Image), if any.
     * @attr label Sets the label. If label is changed, the whole component is invalidate. Thus, you want to smart-update, you have to override this method.
