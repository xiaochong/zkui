...
class ComboBoxTagLib extends AbstractTagLib {
    ...
    /**
     * Components: <tt>combobox</tt> and <tt>comboitem</tt>.A <tt>combobox</tt> is a special text box that embeds a drop-down list. With <tt>comboboxes</tt>, users are allowed to select from a drop-down list, in addition to entering the text manually.
     *
     * @attr open Drops down or closes the list of combo items ( Comboitem.
     * @attr multiline Description copied from class: Textbox Sets whether it is multiline.
     * @attr itemRenderer Sets the renderer by use of a class name. It creates an instance automatically.
     * @attr autodrop Sets whether to automatically drop the list if users is changing this text box.
     * @attr buttonVisible Sets whether the button (on the right of the textbox) is visible.
     * @attr autocomplete Sets whether to automatically complete this text box by matching the nearest item ( Comboitem.
     * @attr selectedIndex Deselects the currently selected items and selects the item with the given index. Note: if the label of comboitem has the same more than one, the first comboitem will be selected at client side, it is a limitation of Combobox and it is different from Listbox.
     * @attr rows Description copied from class: Textbox Sets the rows.
     * @attr tabbable Sets whether TAB is allowed. If true, the user can enter TAB in the textbox, rather than change focus. Default: false.
     * @attr value Sets the value.
     * @attr type Sets the type.
     * @attr disabled Sets whether it is disabled.
     * @attr maxlength Sets the maxlength.
     * @attr tabindex Sets the tab order of this component.
     * @attr readonly Sets whether it is readonly.
     * @attr cols Sets the cols.
     * @attr constraint
     * @attr inplace Sets to enable the inplace-editing function that the look and feel is like a label.
     * @attr errorMessage Associates an error message to this input. It will cause the given error message to be shown at the client. Notice that the application rarely invokes this method. Rather, throw WrongValueException instead. Notice it does not invoke CustomConstraint.showCustomError(org.zkoss.zk.ui.Component, org.zkoss.zk.ui.WrongValueException) even if getConstraint() implements CustomConstraint.
     ...
     * @attr text Sets the value in the String format. In most case, you shall use the setValue method instead, e.g., Textbox.setValue(java.lang.String) and Intbox.setValue(java.lang.Integer). It invokes coerceFromString(java.lang.String) fisrt and then validate(java.lang.Object). Derives might override them for type conversion and special validation.
