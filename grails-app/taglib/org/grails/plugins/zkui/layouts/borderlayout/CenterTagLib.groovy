...
class CenterTagLib extends AbstractTagLib {
     ...
     *
     * @attr height The height can't be specified in this component because its height is determined by other region components ( North or South).
     * @attr open Center region can't be closed.
     * @attr collapsible Center region can't be enabled the collapse functionality.
     * @attr maxsize Center region can't be enabled the maxsize.
     * @attr splittable Center region can't be enabled the split functionality.
     * @attr minsize Center region can't be enabled the minsize.
     * @attr cmargins Center region can't be enabled the collapsed margin functionality.
     * @attr size The size can't be specified in this component.
     * @attr visible This component can't be hidden.
     * @attr width The width can't be specified in this component because its width is determined by other region components ( West or East).
     * @attr flex Sets whether to grow and shrink vertical/horizontal to fit their given space, so called flexibility.
     * @attr margins Sets margins for the element "0,1,2,3" that direction is "top,left,right,bottom"
     * @attr autoscroll Sets whether enable overflow scrolling.
     * @attr title Sets the title.
     * @attr border Sets the border (either none or normal).
