...
class BorderLayoutTagLib extends AbstractTagLib {
    ...
    /**
     * The layout component is a nested component. The parent component is <tt>borderlayout</tt>, and its children components include <tt>north</tt>, <tt>south</tt>, <tt>center</tt>, <tt>west</tt>, and <tt>east</tt>. All extra space is placed in the center area. The combination of children components of <tt>borderlayout</tt> is free.A borderlayout could be nested to another borderlayout (actually, almost all kinds of components) to form a complicated layout.
     *
