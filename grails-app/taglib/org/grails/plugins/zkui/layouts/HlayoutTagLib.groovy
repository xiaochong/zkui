...
class HlayoutTagLib extends AbstractTagLib {
    ...
    /**
     * The hlayout component is a simple horizontal oriented layout. Each component placed in the hlayout will be placed horizontally in a row.Notice that hlayout and vlayout do not support splitter. If you need it, please use <a href="/wiki/ZK_Component_Reference/Layouts/Hbox" title="ZK Component Reference/Layouts/Hbox"> Hbox</a> and <a href="/wiki/ZK_Component_Reference/Layouts/Vbox" title="ZK Component Reference/Layouts/Vbox"> Vbox</a> instead.
     *
     * @attr spacing Sets the spacing between adjacent children.
